...
export const SPECIALTIES = [
  ...
  {
    name: "Dermatology",
    icon: <CircleDot className="h-5 w-5 text-blue-400" />,
  },
  {
    name: "Endocrinology",
  ...
  },
  {
    ...
    icon: <Flower2 className="h-5 w-5 text-blue-400" />,
  },
  {
    name: "Oncology",
  ...
  {
    name: "Orthopedics",
    icon: <Bone className="h-5 w-5 text-blue-400" />,
  },
  {
    name: "Pediatrics",
    icon: <Baby className="h-5 w-5 text-blue-400" />,
  },
  {
    name: "Psychiatry",
    icon: <Brain className="h-5 w-5 text-blue-400" />,
  ...
  {
    name: "Urology",
    icon: <Milestone className="h-5 w-5 text-blue-400" />,
  },
  {
    name: "Other",
