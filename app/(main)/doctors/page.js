...
const SpecialitiesPage = () => {
  return (
    ...
    <div className='flex flex-col items-center justify-center mb-8 text-center'>
      <h1 className='text-3xl font-bold  mb-2 text-transparent bg-clip-text pr-2 bg-gradient-to-b from-blue-500  to-blue-600'>Find Your Doctor</h1>
    ...
    <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
            {SPECIALTIES.map((speciality)=>(
                  <Link key={speciality.name} href={`/doctors/${speciality.name}`}>
                    <Card className={'bg-[#222427] shadow-md shadow-black/50 hover:border-blue-700/40 transition-all cursor-pointer border-blue-20 h-full'}>
